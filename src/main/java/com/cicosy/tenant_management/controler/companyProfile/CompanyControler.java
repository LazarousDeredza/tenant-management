...
public class CompanyControler {
    ...
    public CompanyControler() {
    }

    @PostMapping({"/savecompany"})
    public String saveCompany(@RequestParam("banner") MultipartFile file1, @RequestParam("logo") MultipartFile file2, @RequestParam("company_name") String company_name, @RequestParam("company_location") String company_location, Long id) throws IOException {
        ...
        Company docs = (Company)this.companyProfileRepo.save(comp);
        String uploadDir = System.getProperty("user.dir") + "assets/uploads/companydocs" + docs.getId();
        this.companyProfileService.store(id, uploadDir, banner, file1, company_name, company_location);
        this.companyProfileService.store(id, uploadDir, logo, file2, company_name, company_location);
        return "success";
    }
}